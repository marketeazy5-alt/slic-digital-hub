...
function createSupabaseClient() {
  ...
  if (!SUPABASE_URL || !SUPABASE_PUBLISHABLE_KEY) {
    ...
    console.warn(`[Supabase] Missing environment variable(s): ${missing.join(', ')}. Using noop client.`);
    return createClient<Database>('https://placeholder.supabase.co', 'placeholder-key', { auth: { persistSession: false } });
  }
